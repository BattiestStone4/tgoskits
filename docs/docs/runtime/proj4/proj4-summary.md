...
另有三组已经由上游接续。性能测量那四个（#1577、#1601、#1602、#1603）由 #2274 整合，2026-09-13 合入 `dev`。从设备树读每核算力的 #2001、进程退出时回收设备锁的 #2072，按现在的分层重做成了 #2386 和 #2387，这两个也在 2026-09-13 当天合入 `dev`。依赖 #2001 那份算力数据的 #2064 没有跟进，已经关闭且没有合入，要做得按 #2386 的新接口重写。
